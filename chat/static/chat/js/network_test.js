...
var testStreamingCapability = function(subscriber, callback) {
  performQualityTest({subscriber: subscriber, timeout: TEST_TIMEOUT_MS}, function(error, results) {
    ...
    if (audioVideoSupported) {
      return callback(false, {
        text: 'Everything checks out! You\'re all set for the dates!',
        icon: 'result_ok'
      });
    }
...
var startTest = function(subscriber, callback) {
  ...
  // For other resolutions you may need to adjust the bandwidth conditions in
